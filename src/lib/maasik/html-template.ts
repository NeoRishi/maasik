/**
 * MAASIK Report Template v2.0
 *
 * Source: report-template-v2.html (immutable; do not edit this string directly)
...
<style>
  :root {
    ...
    --cover-primary: [[COVER_PRIMARY_COLOR]];
    --cover-accent: [[COVER_ACCENT_COLOR]];
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cover {
    ...
    background:
      radial-gradient(ellipse 80% 60% at 70% 20%, var(--cover-accent), transparent 55%),
      radial-gradient(ellipse 100% 70% at 30% 80%, var(--cover-primary), transparent 60%),
      var(--cream);
    display: flex;
...
export const HTML_TEMPLATE_VERSION = 'v2.0';
